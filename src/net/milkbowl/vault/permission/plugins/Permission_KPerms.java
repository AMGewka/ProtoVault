    ...
    public Permission_KPerms(Plugin plugin) {
        ...
        if (kperms == null) {
            ...
            if (perms != null && perms.isEnabled()) {
                ...
                plugin.getLogger().info(String.format("[%s][Permission] %s подключён.", plugin.getDescription().getName(), "KPerms"));
            }
        }
    }
        ...
        public void onPluginEnable(PluginEnableEvent event) {
            if(bridge.kperms == null) {
                ...
                if (plugin.getDescription().getName().equals("KPerms")) {
                    ...
                    log.info(String.format("[%s][Permission] %s подключён.", vault.getDescription().getName(), "KPerms"));
                }
            }
        }
        ...
        public void onPluginDisable(PluginDisableEvent event) {
            if(bridge.kperms != null){
                if(event.getPlugin().getDescription().getName().equals(bridge.kperms.getName())) {
                    bridge.kperms = null;
                    log.info(String.format("[%s][Permission] %s отключён.", vault.getDescription().getName(), "KPerms"));
                }
            }
        }
    }
